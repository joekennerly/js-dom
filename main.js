...
let firstEl = document.querySelector(".article__header")
firstEl.textContent = "Welcome to the Joe blog"

// Use JavaScript to obtain a reference to all article__header elements and change their classList property value to article__header important.
let allEl = document.querySelectorAll(".article__header")
// allEl[0].classList.add("important")
// allEl[1].classList.add("important")
